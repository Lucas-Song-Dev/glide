          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                {...register("amount", {
                  ...
                  validate: {
                    ...
                    noLeadingZeros: (value) => {
                      // Check for multiple leading zeros (e.g., "000100.00")
                      if (/^0{2,}/.test(value)) {
                ...
                type="text"
                className="pl-7 block w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500 sm:text-sm p-2 border text-gray-900 dark:text-gray-100"
                placeholder="0.00"
              />
            </div>
                ...
                validate: {
                  validCard: (value) => {
                    ...
                    const cardTypes = [
                      ...
                      { prefix: "30", name: "Diners Club" },
                      { prefix: "36", name: "Diners Club" },
                      { prefix: "38", name: "Diners Club" },
                    ];
                    const validPrefix = cardTypes.some((type) => value.startsWith(type.prefix));
                    if (!validPrefix) {
