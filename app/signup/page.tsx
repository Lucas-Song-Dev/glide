                  ...
                  {...register("phoneNumber", {
                    ...
                    validate: {
                      format: (value) => {
                        ...
                        if (usFormat.test(normalized) || intlFormat.test(normalized)) {
                          return true;
                        }
                        return "Invalid phone number format. Use US format (xxx) xxx-xxxx or international +xxxxxxxxxxxxx";
                      },
                    },
                  })}
                  type="tel"
                  ...
                  <input
                    {...register("state", {
                      ...
                      validate: (value) => {
                        ...
                        return validStates.includes(value.toUpperCase()) || "Invalid state code";
                      },
                    })}
                    type="text"
                    placeholder="CA"
